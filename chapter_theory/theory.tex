...
For a metal with carrier concentrations $n \sim \mathcal{O}(10^{23})$ cm$^{-3}$, $l = 1 -- 10$ nm, $\lambda_F = 0.5$ nm, and $L_\phi = 0.5$\si{\micro\metre}   , where $l$ is a mean free path and includes both elastic and inelastic events.
In comparison, for carrier concentrations $n \sim \mathcal{O}(10^{11})$ cm$^{-2}$, graphene displays $l = 50$ nm--$3 \mu$m, $\lambda_F = 2\sqrt{\pi/n}$ nm, and $L_\phi = 0.5$ \si{\micro\metre} \cite{torres2013introduction}.
