...
\begin{figure}
    \begin{center}
        ...
        \caption{Temperature dependence evolution of the stability diagram map for a single-electron MGNR. Bias and voltage ranges have been limited to the plotted experimental range in order to preserve the stability of the device even at hight temperature. Degeneracy points are not closing at low temperature, an effect which we attribute to the presence of Franck-Condon blockade phenomena \cite{burzuri2014franck}.}
        \label{fig:all_sd}
    \end{center}
\end{figure}
