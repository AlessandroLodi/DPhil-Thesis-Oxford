...
\begin{figure}[hbtp]
    \begin{center}
        ...
        \caption[GNR-porphyrin Hybrid Device: Low- and Room-Temperature Comparison]
        {
            ...
            \textbf{c,} Room-temperature \gls{FET} response of a device under different biases. Upon increasing $V_\textrm{G}$, a drastically reduced conductance is measured, demonstrating p-doping effect. The estimated $E_g\simeq\SI{2}{\electronvolt}$ is in line with what we expect from optical absorption measurements.
...
We attempted two things in this chapter. To begin, in order to investigate the feasibility of doping in graphene nanoribbons, we simulated the engineering of the electronic band structure using \gls{DFT}, when various chemical functionalisations, acting both as donors and acceptors of electrons, are inserted along the lateral edges onto the ribbon.
