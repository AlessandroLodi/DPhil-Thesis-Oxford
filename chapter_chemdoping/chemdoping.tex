...
\begin{figure}[hbtp]
    \begin{center}
        \includegraphics[width=\textwidth]{chapter_chemdoping/figures/sd_experimental_simulated.pdf}
...
\begin{figure}[hbtp]
    \begin{center}
        \includegraphics[width=\textwidth]{chapter_chemdoping/figures/Phonon_Mode_Comparison.pdf}
...
\begin{figure}[hbtp]
    \begin{center}
        \includegraphics[width=\textwidth]{chapter_chemdoping/figures/phonon_anthracene_malimide.pdf}
...
Furthermore, first-principles studies have suggested the existence of edge-localized nonlinear modes in \glspl{AGNR} with energies \SIrange{6.8}{8.7}{\milli\electronvolt}~\cite{savin2016localized}, which would encompass our experimental and \gls{DFT} findings. Based on these, the electronic wave function of our \glspl{GNR} should be edge-localised and may have a non-zero overlap with edge-localised vibrational states. The corresponding vibrons are predicted to be coupled more strongly~\cite{droth2011acoustic}, which might explain why $G\sim\hbar\omega_\nu\simeq\SI{7}{\milli\electronvolt}$ is higher than lower-lying vibrons.
