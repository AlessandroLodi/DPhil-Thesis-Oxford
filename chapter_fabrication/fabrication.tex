...
\section{Room Temperature Overview Setup}

During my thesis, a great effort was dedicated to the study of graphene-based single-molecule transistors when graphene nanoribbons or $\pi$-extended bridges the two leads. Towards this goal and in order to stay within the coherent transport regime, nanometer graphene junctions were routinely prepared. Whilst I have used protocols from the literature, I improved an easy to use python library written on legacy code by Dr.\ Bart Limburg and Dr.\ James Thomas.
